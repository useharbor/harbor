                ...
                {!login &&
                    <>
                        ...
                        <div className={`flex flex-col justify-center p-8 ${login ? 'opacity-0 invisible' : 'opacity-100 visible'}`}>
                            ...
                            <input type="text" placeholder="Name" value="sdsadsa" className="input-field mb-4 p-2 border rounded" />
                            <input type="email" placeholder="Email" value={email} onChange={handleEmailChange} className="input-field mb-4 p-2 border rounded" />
                            ...
                            <button onClick={handleSignIn} className="bg-indigo-500 text-white font-bold py-2 px-4 rounded hover:bg-indigo-600 transition-colors">Sign Up</button>
                        </div>
                    </>
